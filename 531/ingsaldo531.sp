/************************************************************************/
/*  Archivo:                         ingsaldo531.sp                     */
/*  Stored procedure:                sp_ingresa_saldo_531               */
...
if exists (select 1 from sysobjects where name = 'sp_ingresa_saldo_531')
   drop proc sp_ingresa_saldo_531
go

create proc sp_ingresa_saldo_531(
  @i_empresa       int,
  @i_periodo       int,
  @i_corte         int,
  @i_proceso       int,
...
select @w_sp_name ='sp_ingresa_saldo_531'
