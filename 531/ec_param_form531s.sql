...
select @w_proceso =  28857, -- numero de proceso semanal
       @w_tabla = 0,
       @w_max_fila = 0,
       @w_col = 0,
       @w_fil = 0,
...
----------------------------------------------------
print 'Agregando tipo de informe 80 "INDICADORES DE EXPOSICION DE CORTO PLAZO INDIVIDUAL A SIETE DIAS" al catalogo'
...
begin
   ...
   insert into cobis..cl_catalogo values (@w_tabla,@w_tipo_inf,'INDICADORES DE EXPOSICION DE CORTO PLAZO INDIVIDUAL A  SIETE DIAS','V',NULL,NULL,NULL)
...
print 'Parametrizacion Formato 531 tipo informe 80'
...
values
 (
   @w_proceso         , 531           , 41,
   '01'               , '02'          , 'ecfor531s',
   '01'               , 'S'           , 'INDICADORES DE EXPOSICION DE CORTO PLAZO - FORMATO 531 SEMANAL',
   'E'                , '01'          , '80',
   2                  , 'V'           , 'N'
  )
