/**********************************************************************/
/*  Archivo:              ec_estructura_externos_form531.sql          */
...
/**********************************************************************/
/*                        PROPOSITO                                   */
/*  Creacion de estructuras cob_externos formato 531                  */
/**********************************************************************/
/*                         MODIFICACIONES                             */
/*  FECHA         AUTOR                   RAZON                       */
...
print '********************************'
print ''
print 'Inicio Ejecucion Creacion de Tablas para Formato 531 en cob_externos : ' + convert(varchar(60),getdate(),109)
print ''

if exists (select 1 from sysobjects where name = 'ex_dato_inventariofrwd' and type = 'U') 
   drop table ex_dato_inventariofrwd
go
print '-->Tabla: ex_dato_inventariofrwd'
   create table ex_dato_inventariofrwd(
...
if exists (select 1 from sysobjects where name = 'ex_dato_haircut_mon' and type = 'U') 
   drop table ex_dato_haircut_mon
go
print '-->Tabla: ex_dato_haircut_mon'
   create table ex_dato_haircut_mon(
